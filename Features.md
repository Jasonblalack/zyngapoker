...
Jasy generates API data from different JavaScript declarations ([Core Library](http://github.com/zynga/core), plain JavaScript, …). When using **Core** Jasy supports the following features:
